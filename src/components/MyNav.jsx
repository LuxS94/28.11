...
function MyNav() {
    const oggi= new Date();
    const today = `${oggi.getDate()}/${oggi.getMonth()+1}/${oggi.getFullYear()}`;
   

  return (
    <Navbar  className="bg-body-tertiary fixed-top " expand="lg">
      <Container fluid className='d-flex justify-content-center'>
        <Navbar.Brand href="#home" ><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-cloud-sun" viewBox="0 0 16 16">
...
</svg> Il Mio Meteo</Navbar.Brand><Navbar.Brand>{today}</Navbar.Brand>
